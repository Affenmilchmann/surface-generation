...
int main()
{
	...
	while (input != "exit" and input != "q" and input != "quit")
	{
		inp();
		std::cin >> input;
		...
		else if (input == "water")
		{
			...
			try
			{
				...
				{
					my_surf.set_water(water);
					std::cout << "Water has been changed to " + input + "!\n";
				}
		...
		else if (input == "sand")
		{
			...
			try
			{
				...
				{
					my_surf.set_sand(sand);
					std::cout << "Sand has been changed to " + input + "!\n";
				}
				else std::cout << "Size is incorrect! \n";
			}
			catch (std::exception e)
		...
		else if (input == "smooth")
		{
			...
			try
			{
				...
				if (smooth >= 0) 
				{
					my_surf.set_smooth(smooth);
					std::cout << "Smooth has been changed to " + input + "!\n";
				}
				else std::cout << "Size is too small! \n";
			}
			catch (std::exception e)
		...
		else if (input == "grad")
		{
			...
			try
			{
				...
				{
					my_surf.set_grad(grad);
					std::cout << "Grad has been changed to " + input + "!\n";
				}
				else std::cout << "Size is incorrect! \n";
			}
			catch (std::exception e)
		...
		else if (input != "exit" and input != "q" and input != "quit")
...
void help()
{
	std::cout << "You can setup the map settings with commands:  "
		<< "\n(write a command and then a number)"
		<< "\n size"
		<< "\n water"
		<< "\n sand"
		<< "\n smooth"
